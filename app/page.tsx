...
const insuranceServices: GridItem[] = [
  ...
  },
  {
    ...
    description: 'We leverage our strong network in the global reinsurance market to provide solutions that cover a wide range of risks. This allows for portfolio diversification and enhanced stability, enabling us to maximize profitability while maintaining a low loss ratio.',
    image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=3948&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    id: '3',
    title: 'Tailored Risk Management Solutions for SMEs',
    description: 'We offer customized risk management solutions for small and medium-sized enterprises (SMEs) that play a vital role in the Korean economy. We analyze the specific risks of each company and design strategic solutions to minimize them, helping SMEs achieve stable growth.',
  ...
  },
  {
    ...
    description: 'We provide systematic education programs and safety management systems to prevent accidents and minimize risks. By proactively blocking potential risks that our clients may face, we lower the accident rate and strengthen business stability.',
    image: 'https://images.unsplash.com/photo-1542744095-291d1f67b221?q=80&w=3948&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
];
